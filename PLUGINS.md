...
- `/pf-design-tokens:pf-tokens` — Build CSS design tokens for PatternFly core and copy them to the PatternFly repository.
- `/pf-design-tokens:raw-colors-scan` — "Analyze the provided code to find any raw color values assigned to styling properties. Flag these values as technical debt and suggest their replacement with design tokens."
