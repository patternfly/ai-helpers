...
description: Standardize PatternFly React testing — RTL patterns, mock boundaries, coverage expectations, and assertion style. Use when writing or reviewing unit tests for PF components.
---
