...
```text
User: /pf-styling:analyze-modifiers
```
...
```text
User: /pf-styling:analyze-modifiers for the Button component
```
...
```text
User: /pf-styling:analyze-modifiers find where pf-m-disabled is used
```
...
```text
User: /pf-styling:analyze-modifiers compare pf-m-expanded and pf-m-collapsed
```
