...
export const CardEventsView: React.FunctionComponent = () => {
  ...
  const toggle = (
    toggleRef: React.LegacyRef<MenuToggleElement> | undefined
  ) => (
    <MenuToggle
      ref={toggleRef}
      ...
      <CardBody>
        <DescriptionList>
          <DescriptionListGroup>
            ...
            <DescriptionListDescription>
              Readiness probe failed: Get https://10.131.0.7:5000/healthz: dial
              tcp 10.131.0.7:5000: connect: connection refused
            </DescriptionListDescription>
            <DescriptionListDescription>
              <Timestamp
          ...
          <DescriptionListGroup>
            ...
            <DescriptionListDescription>
              Successfully assigned default/example to
              ip-10-0-130-149.ec2.internal
            </DescriptionListDescription>
            <DescriptionListDescription>
              <Timestamp
          ...
          <DescriptionListGroup>
            ...
            <DescriptionListDescription>
              Migrated 2 pods to other hosts
            </DescriptionListDescription>
            <DescriptionListDescription>
              <Timestamp
          ...
          <DescriptionListGroup>
            ...
            <DescriptionListDescription>
              Rebuild initiated as Disk 5 failed
            </DescriptionListDescription>
            <DescriptionListDescription>
              <Timestamp
                date={new Date("2023-06-17T13:33:00Z")}
          ...
          <DescriptionListGroup>
            ...
            <DescriptionListDescription>
              Created container hello-openshift-123
            </DescriptionListDescription>
            <DescriptionListDescription>
              <Timestamp
          ...
          <DescriptionListGroup>
            ...
            <DescriptionListDescription>
              Created container hello-openshift-456
            </DescriptionListDescription>
            <DescriptionListDescription>
              <Timestamp
