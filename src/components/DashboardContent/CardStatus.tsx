...
export const CardStatus: React.FunctionComponent = () => {
  ...
  const popoverBodyContent = (
    <>
      <div>
        Components of the Control Panel are responsible for maintaining and
          ...
          const parentRow = (
            <Tr key={rowIndex}>
              <Td
                ...
                expand={
                  row.child && {
                    isExpanded: rowsExpanded[rowIndex],
                    rowIndex,
      ...
      <Grid hasGutter sm={6} lg={3}>
        ...
        <GridItem>
          <Flex spaceItems={{ default: "spaceItemsSm" }}>
            ...
            <FlexItem>
              <Popover
                headerContent="Control Panel Status"
        ...
        >
          <NotificationDrawerList isHidden={!drawerExpanded}>
            <NotificationDrawerListItem variant="danger">
              ...
              />
              <NotificationDrawerListItemBody>
                This is a long description to show how the title will wrap if it
                is long and wraps to multiple lines.
              </NotificationDrawerListItemBody>
            </NotificationDrawerListItem>
