          ...
          <Grid md={6} lg={4} hasGutter>
              ...
              >
                ...
                <Content>
                  <Content component="p">
                    ...
                    issues, kernel panics, network instabilities and issues with
                    system performance
                  </Content>
                </Content>
                <Flex
            ...
            >
              ...
              >
                ...
                <Content component="p">
                  Adjust your networking configuration to get ahead of network
                  perfomance degradations and packet losses
                </Content>
                <Flex
                  grow={{ default: "grow" }}
                  direction={{ default: "column", lg: "row" }}
            ...
            >
              ...
              >
                ...
                <Content component="p">
                  Fine tune your Oracle DB configuration to improve database
                  performance and avoid process failure
                </Content>
                <Flex
                  grow={{ default: "grow" }}
                  direction={{ default: "column", lg: "row" }}
