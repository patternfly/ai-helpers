...
export const CardNested: React.FunctionComponent = () => {
  ...
  return (
    <Card id="nested-cards-card">
      ...
      <Card
        id="nested-cards-toggle-group-1"
        isPlain
        isExpanded={isCardExpanded1}
      >
        <CardHeader
          ...
          toggleButtonProps={{
            ...
            "aria-label": "Details",
            "aria-labelledby":
              "nested-cards-toggle-group-1-title toggle-button-1",
      ...
      <Card
        id="nested-cards-toggle-group-2"
        isPlain
        isExpanded={isCardExpanded3}
      >
        <CardHeader
          ...
          toggleButtonProps={{
            ...
            "aria-label": "Details",
            "aria-labelledby":
              "nested-cards-toggle-group-2-title toggle-button-2",
      ...
      <Card
        id="nested-cards-toggle-group-3"
        isPlain
        isExpanded={isCardExpanded2}
      >
        <CardHeader
          ...
          toggleButtonProps={{
            ...
            "aria-label": "Details",
            "aria-labelledby":
              "nested-cards-toggle-group-3-title toggle-button-3",
